...
namespace VirtualRobot
{
    ...
    RobotNodeHemisphereFactory::RobotNodeHemisphereFactory() = default;


    RobotNodeHemisphereFactory::~RobotNodeHemisphereFactory() = default;

    RobotNodePtr
    RobotNodeHemisphereFactory::createRobotNode(RobotPtr robot,
    ...
    RobotNodePtr
    RobotNodeHemisphereFactory::createRobotNodeDH(RobotPtr robot,
                                                  const std::string& nodeName,
                                                  VisualizationNodePtr visualizationModel,
                                                  CollisionModelPtr collisionModel,
                                                  float limitLow,
    ...
    RobotNodeFactory::SubClassRegistry
        RobotNodeHemisphereFactory::registry(RobotNodeHemisphereFactory::getName(),
                                             &RobotNodeHemisphereFactory::createInstance);
