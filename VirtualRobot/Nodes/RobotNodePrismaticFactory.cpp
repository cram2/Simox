...
namespace VirtualRobot
{
    ...
    RobotNodePrismaticFactory::RobotNodePrismaticFactory() = default;
     ...
     */
    RobotNodePtr
    RobotNodePrismaticFactory::createRobotNode(RobotPtr robot,
    ...
    {
        RobotNodePtr robotNode(new RobotNodePrismatic(
            robot,
            nodeName,
            limitLow,
            limitHigh,
     ...
     */
    RobotNodePtr
    RobotNodePrismaticFactory::createRobotNodeDH(RobotPtr robot,
                                                 const std::string& nodeName,
                                                 VisualizationNodePtr visualizationModel,
                                                 CollisionModelPtr collisionModel,
                                                 float limitLow,
                                                 ...
                                                 RobotNode::RobotNodeType rntype) const
    {
        RobotNodePtr robotNode(new RobotNodePrismatic(robot,
                                                      nodeName,
                                                      limitLow,
                                                      limitHigh,
                                                      dhParameters.aMM(),
    ...
    RobotNodeFactory::SubClassRegistry
        RobotNodePrismaticFactory::registry(RobotNodePrismaticFactory::getName(),
                                            &RobotNodePrismaticFactory::createInstance);

    /**
     * \return "prismatic"
     */
    std::string
    RobotNodePrismaticFactory::getName()
    {
        return "prismatic";
    }
    ...
    RobotNodePrismaticFactory::createInstance(void*)
    {
        std::shared_ptr<RobotNodePrismaticFactory> prismaticNodeFactory(
            new RobotNodePrismaticFactory());
