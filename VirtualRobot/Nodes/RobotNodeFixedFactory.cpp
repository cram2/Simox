...
namespace VirtualRobot
{
    ...
    RobotNodeFixedFactory::RobotNodeFixedFactory() = default;
     ...
     */
    RobotNodePtr
    RobotNodeFixedFactory::createRobotNode(RobotPtr robot,
    ...
    {
        RobotNodePtr robotNode(new RobotNodeFixed(
            robot,
            nodeName,
            preJointTransform,
            visualizationModel,
     ...
     */
    RobotNodePtr
    RobotNodeFixedFactory::createRobotNodeDH(RobotPtr robot,
                                             const std::string& nodeName,
                                             VisualizationNodePtr visualizationModel,
                                             CollisionModelPtr collisionModel,
                                             float /*limitLow*/,
                                             ...
                                             RobotNode::RobotNodeType rntype) const
    {
        RobotNodePtr robotNode(new RobotNodeFixed(robot,
                                                  nodeName,
                                                  dhParameters.aMM(),
                                                  dhParameters.dMM(),
    ...
    RobotNodeFactory::SubClassRegistry
        RobotNodeFixedFactory::registry(RobotNodeFixedFactory::getName(),
                                        &RobotNodeFixedFactory::createInstance);

    /**
     * \return "fixed"
     */
    std::string
    RobotNodeFixedFactory::getName()
    {
        return "fixed";
    }
    ...
    RobotNodeFixedFactory::createInstance(void*)
    {
