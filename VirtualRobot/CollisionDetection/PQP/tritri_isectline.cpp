...
int
tri_tri_intersect(float V0[3], float V1[3], float V2[3], float U0[3], float U1[3], float U2[3])
{
    float E1[3], E2[3];
...
int
NoDivTriTriIsect(float V0[3], float V1[3], float V2[3], float U0[3], float U1[3], float U2[3])
{
    float E1[3], E2[3];
    float N1[3], N2[3], d1, d2;
    float du0, du1, du2, dv0, dv1, dv2;
...
inline int
compute_intervals_isectline(const float VERT0[3],
                            const float VERT1[3],
                            const float VERT2[3],
                            float VV0,
                            float VV1,
...
int
tri_tri_intersect_with_isectline(const float V0[3],
                                 const float V1[3],
                                 const float V2[3],
                                 const float U0[3],
                                 const float U1[3],
