...
BOOST_AUTO_TEST_CASE(testSceneEmptyXML)
{
    ...
    BOOST_REQUIRE_THROW((VirtualRobot::SceneIO::createSceneFromString(sceneString)),
...
BOOST_AUTO_TEST_CASE(testSceneUnclosedSceneTag)
{
    ...
    BOOST_REQUIRE_THROW(scene = VirtualRobot::SceneIO::createSceneFromString(sceneString),
                        VirtualRobot::VirtualRobotException);
}
...
{
    const std::string sceneString =
        "<Scene name='test'><Robot name='testRob'><File></File></Robot></Scene>";
    BOOST_REQUIRE_THROW(VirtualRobot::SceneIO::createSceneFromString(sceneString),
                        VirtualRobot::VirtualRobotException);
}
...
{
    const std::string sceneString =
        "<Scene name='test'><Robot name='testRob'><File>thisisnotarobot.xml</File></Robot></Scene>";
    BOOST_REQUIRE_THROW(VirtualRobot::SceneIO::createSceneFromString(sceneString),
                        VirtualRobot::VirtualRobotException);
}
