...
BOOST_AUTO_TEST_CASE(testGazeIK)
{
    const std::string robotString =
        ...
        "            <Limits unit='mm' lo='0' hi='10000' allowAvoidance='false'/>              "
        "        </Joint>                                                                        "
        "    </RobotNode>                                                                        "
        "                                                                                        "
        "    <RobotNodeSet name='IKVirtualGaze' kinematicRoot='Neck_1_Pitch'                     "
        "                  tcp='VirtualCentralGaze'>                                             "
    ...
    VirtualRobot::RobotNodePrismaticPtr nodeTrans =
        std::dynamic_pointer_cast<VirtualRobot::RobotNodePrismatic>(node);
