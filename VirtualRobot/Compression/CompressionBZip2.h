...
namespace VirtualRobot
{
    ...
    protected:
        ...
        */
        ...
        int BZ2_bzDecompressInit(bz_stream* strm, int verbosity, int smallValue);
        ...
        static void BZ2_hbMakeCodeLengths(UChar* len, Int32* freq, Int32 alphaSize, Int32 maxLen);
        static void
