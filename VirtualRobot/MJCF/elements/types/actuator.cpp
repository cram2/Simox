...
Eigen::VectorXf
ActuatorGeneral::gainprmDefault()
{
    Eigen::VectorXf v(10);
    v.setZero();
    v(0) = 1;
...
Eigen::VectorXf
ActuatorGeneral::biasprmDefault()
{
    Eigen::VectorXf v(10);
    v.setZero();
    return v;
...
Eigen::Vector2f
ActuatorMuscle::timeconstDefault()
{
    return Eigen::Vector2f(0.01, 0.04);
}

Eigen::Vector2f
ActuatorMuscle::rangeDefault()
{
...
ElementD
addActuator(ActuatorSection& as, const std::string& joint)
{
...
ActuatorMotor
ActuatorSection::addMotor(const std::string& joint)
{
    return addActuator<ActuatorMotor>(*this, joint);
}

ActuatorPosition
ActuatorSection::addPosition(const std::string& joint, float kp)
{
...
ActuatorVelocity
ActuatorSection::addVelocity(const std::string& joint, float kv)
{
