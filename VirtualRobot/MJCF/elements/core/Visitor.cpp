...
namespace mjcf
{
    ...
    Visitor::Adapter::Adapter(Visitor& owner) : owner(owner)
    {
    }

    bool
    Visitor::Adapter::VisitEnter(const tinyxml2::XMLElement& element, const tinyxml2::XMLAttribute*)
    {
        return owner.visitEnter(owner.cast(element));
    }

    bool
    Visitor::Adapter::VisitExit(const tinyxml2::XMLElement& element)
    {
    ...
    const Visitor::Adapter*
    Visitor::adapter() const
    {
        return &_adapter;
    }

    const AnyElement
    Visitor::cast(const tinyxml2::XMLElement& element)
    {
