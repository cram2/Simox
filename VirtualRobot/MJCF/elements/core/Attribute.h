...
namespace mjcf
{
    ...
    public:
        ...
        Attribute&
        operator=(const Attribute<OtherDerived, OtherAttrT>& attribute)
        {
        ...
        template <class OtherDerived, class OtherAttrT>
        Attribute&
        operator=(Attribute<OtherDerived, OtherAttrT>&& attribute)
        {
            this->set(attribute.get());
            return *this;
        }
        ...
        */
        template <class OtherDerived, class OtherAttrT>
        bool
        operator==(const Attribute<OtherDerived, OtherAttrT>& rhs)
        {
            return get() == rhs.get();
        }
        ...
        isSet() const
        {
            return this->owner().isAttributeSet(this->name);
        }
    ...
    template <class Derived, typename AttrT>
    std::ostream&
    operator<<(std::ostream& os, const Attribute<Derived, AttrT>& rhs)
    {
        os << rhs.get();
        return os;
    }
    ...
    public:
        ...
        bool
        isRequired() const override
        {
            return required;
        }

        bool
        hasDefault() const override
        {
            return false;
        }
    ...
    public:
        ...
        AttributeDef(Element<Derived>& element,
                     const std::string& name,
                     const AttrT& defaultValue) :
...
#define mjcf_AttributeFullNoDef(Derived, AttrT, memberName, attrName, required)                    \
    ::mjcf::AttributeNoDef<Derived, AttrT> memberName                                              \
    {                                                                                              \
        *this, attrName, required                                                                  \
    }
...
#define mjcf_AttributeFullDef(Derived, AttrT, memberName, attrName, defaultValue)                  \
    ::mjcf::AttributeDef<Derived, AttrT> memberName                                                \
    {                                                                                              \
...
// bool shorthands
#define mjcf_BoolAttributeReq(Derived, name) mjcf_AttributeReq(Derived, bool, name)
#define mjcf_BoolAttributeOpt(Derived, name) mjcf_AttributeOpt(Derived, bool, name)
#define mjcf_BoolAttributeDef(Derived, name, defaultValue)                                         \
    mjcf_AttributeDef(Derived, bool, name, defaultValue)

// int shorthands
#define mjcf_IntAttributeReq(Derived, name) mjcf_AttributeReq(Derived, int, name)
#define mjcf_IntAttributeOpt(Derived, name) mjcf_AttributeOpt(Derived, int, name)
#define mjcf_IntAttributeDef(Derived, name, defaultValue)                                          \
    mjcf_AttributeDef(Derived, int, name, defaultValue)


// float shorthands
#define mjcf_FloatAttributeReq(Derived, name) mjcf_AttributeReq(Derived, float, name)
#define mjcf_FloatAttributeOpt(Derived, name) mjcf_AttributeOpt(Derived, float, name)
...
#define mjcf_Vector3fAttributeReq(Derived, name) mjcf_AttributeReq(Derived, Eigen::Vector3f, name)
#define mjcf_Vector3fAttributeOpt(Derived, name) mjcf_AttributeOpt(Derived, Eigen::Vector3f, name)
#define mjcf_Vector3fAttributeDef(Derived, name, defaultValue)                                     \
    mjcf_AttributeDef(Derived, Eigen::Vector3f, name, defaultValue)


// name
#define mjcf_NameAttribute(Derived) mjcf_StringAttributeOpt(Derived, name)

// class
#define mjcf_ClassAttribute(Derived) mjcf_AttributeKwReq(Derived, std::string, class)

// group
#define mjcf_GroupAttribute(Derived) mjcf_IntAttributeDef(Derived, group, 0)
...
// pos
#define mjcf_PosAttribute(Derived) mjcf_Vector3fAttributeDef(Derived, pos, Eigen::Vector3f::Zero())
