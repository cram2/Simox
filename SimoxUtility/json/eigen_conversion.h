...
namespace Eigen
{
    ...
    void
    to_json(simox::json::json& j, const Eigen::Transform<T, N, Type>& transform)
    {
    ...
    template <typename T, int N, int Type>
    void
    from_json(const simox::json::json& j, Eigen::Transform<T, N, Type>& transform)
    {
    ...
    namespace jsonbase
    {
        ...
        template <typename Derived>
        void
        to_json(simox::json::json& j, const Eigen::MatrixBase<Derived>& matrix)
        {
            for (int row = 0; row < matrix.rows(); ++row)
            {
                if (matrix.cols() > 1)
        ...
        template <typename _Scalar, int _Rows, int _Cols, int _Options, int _MaxRows, int _MaxCols>
        void
        from_json(const simox::json::json& j,
                  Eigen::Matrix<_Scalar, _Rows, _Cols, _Options, _MaxRows, _MaxCols>& matrix)
        {
            using Index =
                typename Eigen::Matrix<_Scalar, _Rows, _Cols, _Options, _MaxRows, _MaxCols>::Index;
        ...
        template <typename Derived>
        void
        from_json(const simox::json::json& j, Eigen::MatrixBase<Derived>& matrix)
        {
    ...
    template <typename Derived>
    void
    to_json(simox::json::json& j, const Eigen::QuaternionBase<Derived>& quat)
    {
        j["qw"] = quat.w();
        j["qx"] = quat.x();
        j["qy"] = quat.y();
    ...
    template <typename Derived>
    void
    from_json(const simox::json::json& j, Eigen::QuaternionBase<Derived>& quat)
    {
